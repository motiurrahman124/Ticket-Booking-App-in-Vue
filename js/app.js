var app = Vue.createApp({
    data(){
        return{
            ...
            seats:[
                ...
                {name: "C1", type: "sold", price: 500},
                {name: "C2", type: "sold", price: 500},
                {name: "C3", type: "sold", price: 500},
                {name: "C4", type: "sold", price: 500},
                ...
                {name: "E3", type: "booked", price: 300},
                {name: "E4", type: "booked", price: 300},
    ...
    methods: {
        clickedSeat(i){
            let handleClick = this.seats[i];
            if(handleClick.type == "booked" || handleClick.type == "sold"){
            ...
            handleClick.type = handleClick.type === "selected"? "available":"selected";
        },
        confirm(){
